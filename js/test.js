...
var mobile = createCommonjsModule(function (module) {
  ...
  */
	...
	(function (global, factory) {
		...
		// amd requirejs
			...
			// cmd seajs
			else if (typeof undefined === "function" && undefined.cmd) {
		...
		Mobile.fn = Mobile.prototype = {
			...
			init: function init(selector, content) {
				...
				if (!content) {
					...
					} else if ((typeof selector === "undefined" ? "undefined" : _typeof$$1(selector)) === "object") {
					...
					if (typeof content === "string" && typeof selector === "string") {
						...
						Array.prototype.push.apply(this, arrs);
					} else if ((typeof content === "undefined" ? "undefined" : _typeof$$1(content)) === "object" && typeof selector === "string") {
						if (selector.trim().length === 0) {
							return this;
						}
						// 遍历数组型对象
		...
		Mobile.extend = Mobile.fn.extend = function (obj) {
			...
			if ((typeof target === "undefined" ? "undefined" : _typeof$$1(target)) !== "object" && !Mobile.isFunction(target)) {
				target = {};
			}
     ...
     */
			...
			type: function type(obj) {
				...
				return (typeof obj === "undefined" ? "undefined" : _typeof$$1(obj)) === "object" || typeof obj === "function" ? class2type[toString.call(obj)] || "object" : typeof obj === "undefined" ? "undefined" : _typeof$$1(obj);
			}
		...
		Mobile.fn.extend({
			...
			css: function css(attr, value) {
				...
				//set 对象的值
				if (arguments.length === 1 && (typeof attr === "undefined" ? "undefined" : _typeof$$1(attr)) === "object") {
					Mobile.each(this, function (i, v) {
			...
			append: function append(obj) {
				if ((typeof obj === "undefined" ? "undefined" : _typeof$$1(obj)) === "object" && obj.length && obj.length > 0) {
					Mobile.each(this, function () {
						for (var i = 0; i < obj.length; i++) {
		...
		Mobile.fn.extend({
			on: function on(type) {
				...
				// 正常绑定事件传object值
				if (arguments.length >= 3 && _typeof$$1(arguments[1]) === "object" && typeof arguments[2] === "function") {
				...
				// 委托绑定事件传object值
				if (arguments.length >= 4 && typeof arguments[1] === "string" && _typeof$$1(arguments[2]) === "object" && typeof arguments[3] === "function") {
			...
			tap: function tap() {
				...
				Mobile.each(this, function (i, v) {
					...
					// 使用委托事件	
						...
						// 使用事件data		
						else if (args.length >= 2 && _typeof$$1(args[0]) === "object" && typeof args[1] === "function") {
								fn = args[1];
								bl = args[2] || false;
								var obj = args[0];
								isDeleDageTarget = true;
							...
							// 使用委托事件传值data	
							else if (args.length >= 3 && typeof args[0] === "string" && _typeof$$1(args[1]) === "object" && typeof args[2] === "function") {
									deletage = args[0];
									var obj = args[1];
									fn = args[2];
									bl = args[3] || false;
 ...
 */
	(function (Mobile) {
		...
		function _ajaxFun(url, type, data, _arguments) {
			...
			var error;
			var progress;
			if ((typeof data === "undefined" ? "undefined" : _typeof$$1(data)) === "object" && _arguments.length > 2) {
			...
			Mobile.ajax({
				type: type,
				url: url,
				data: (typeof data === "undefined" ? "undefined" : _typeof$$1(data)) === "object" ? data : null,
				success: success,
				error: error,
				progress: progress
			});
			...
			for (var key in data) {
				...
				if (data2 === undefined) {
					...
					for (var key2 in data2) {
						...
						if ((typeof data3 === "undefined" ? "undefined" : _typeof$$1(data3)) === "object") {
    ...
    */
			ajax: function ajax(opt) {
				...
				opt.data = _typeof$$1(opt.data) === "object" ? opt.data : {};
